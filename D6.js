...
let numbersArr = [2, 5, 6, 7, 13, 15, 22, 18, 23];
function filtered(arr) {
  return arr.filter((number) => number % 2 == 0);
}

console.log(filtered(numbersArr));

// function filtered2(arr) {
...
let numeriDaSommare = [1, 2, "prova", 5];
...
console.log(sum(numeriDaSommare));
...
console.log(arrSum(numbersArr));
/* ESERCIZIO 6 (map)
  Scrivi una funzione che, dato un array di soli numeri e un numero n come parametri, ritorni un secondo array con tutti i valori del precedente incrementati di n
*/

function mapNumbersArr(arr, n) {
  return arr.map((num) => num + n);
}

console.log(mapNumbersArr(numbersArr, 10));
/* ESERCIZIO 7 (map)
  Scrivi una funzione che, dato un array di stringhe, ritorni un nuovo array contenente le lunghezze delle rispettive stringhe dell'array di partenza
  es.: ["EPICODE", "is", "great"] => [7, 2, 5]
*/

let arrayStringhe = ["ciao", "come", "va"];

function mapStringArr(arr) {
  return arr.map((stringa) => stringa.length);
}

console.log(mapStringArr(arrayStringhe));
